...
Gem::Specification.new do |spec|
  ...
  spec.summary = "A Phlex-based scaffold generator for Rails."
  spec.description = "Phlex::Rails::Scaffold intercepts the default Rails scaffold generator to produce Phlex views and controllers that render them."
