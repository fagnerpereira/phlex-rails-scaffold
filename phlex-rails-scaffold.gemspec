...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Phlex scaffold generator for Rails."
  spec.description = "A Rails generator that produces Phlex view classes instead of ERB templates. It automates the creation of Phlex components for scaffolded resources, following Phlex::Rails conventions for view organization."
