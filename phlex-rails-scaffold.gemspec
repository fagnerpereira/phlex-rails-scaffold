...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Rails scaffold generator for Phlex views"
  spec.description = "Intercepts Rails scaffold generators to output Phlex view classes and controllers that explicitly render them."
  ...
  spec.metadata["changelog_uri"] = "https://github.com/fagnerpereira/phlex-rails-scaffold/releases"
